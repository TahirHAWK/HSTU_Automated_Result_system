...
exports.register = function(req, res){
    ...
    admin.register().then((result) => {
        ...
        req.session.save(function(){
            ...
            req.session.admin = {favColor: 'blue', registerName: admin.data.registerName, registerEmail: admin.data.registerEmail, loginAs: 'admin'}
            req.session.save(function(){
                res.redirect('/adminHome')
            })
        }
...
exports.login = function(req, res){
    ...
    .then(function(result){
        ...
        req.session.admin = {favColor: 'blue', registerEmail: result.registerEmail, registerName: result.registerName, loginAs: 'admin'}
...
exports.home = function(req, res){
    ...
    if(req.session.admin && req.session.admin.loginAs == 'admin'){
        res.render('adminDashboard', {registerName: req.session.admin.registerName, from: 'adminDashboard'})
    } else {
